 ...
 */
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if fromViewController.swipableViewControllerToPresentOnLeft == toViewController {
            ...
            directionalViewOffset = containerView.frame.size.height - (containerView.frame.size.height - toViewController.contentHeight)
...
//            fatalError("Error: Unexpected view controller stack.")
        ...
        if !isToMainViewController && isPresenting {
            if fromViewController.isPanningHorizontally && (toViewController is SettingsViewController) == false { // left/right (second conditional for tap to bring up settings)
        ...
        UIView.animate(withDuration: self.transitionDuration(using: transitionContext), animations: {
            ...
            if transitionContext.transitionWasCancelled {
                if let controller = toViewController as? MainViewController {
